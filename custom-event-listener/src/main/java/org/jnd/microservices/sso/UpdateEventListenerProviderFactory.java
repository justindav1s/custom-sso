 ...
 */
public class UpdateEventListenerProviderFactory implements EventListenerProviderFactory {
    ...
    public EventListenerProvider create(KeycloakSession session) {
        return new UpdateEventListenerProvider(excludedEvents, excludedAdminOperations);
    }
